    ...
    <div class="panel panel-white">
      ...
      <div class="panel-heading hbuilt">
        ...
        <div class="panel-body">
          <div class="col-md-12">
            <?php echo form_open('permission/permrolesubmit', array('class' => 'form-horizontal form-label-left', 'id'=>'demo-form2')); ?>
            ...
            <div class="form-group" id="showdiv">
              <label class="control-label col-md-3 col-sm-3 col-xs-12 text-right">Roles <b class="text-danger">*</b></label>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <select required id="allroles" name="allroles" class="js-source-states form-control" style="width: 100%">
