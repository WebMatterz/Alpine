...
if(isset($_SESSION['username'])) {
	...
	<head>
		...
		<link href="<?php echo base_url(); ?>assets/css/googlefont.min.css" rel="stylesheet">
		...
		<!-- Theme Styles -->
		<link href="<?php echo base_url(); ?>assets/css/metrotheme.min.css" rel="stylesheet">
	...
	<body>
		...
		<div class="page-container">
			...
			<div class="page-sidebar">
				<a class="logo-box" href="<?php echo base_url(); ?>dashboard"><span><h4><b>Informal Sector</b></h4></span><i class="fa fa-circle-thin" id="fixed-sidebar-toggle-button"></i>
									...
									foreach ($_SESSION['AAA'] as $value) { ?>
										<li>
											<a href="javascript:void(0);"><span class="fa fa-arrow"></span>
												<span><?php  print ucfirst($value); ?> &nbsp; <i class="fa fa-angle-right"></i></span>
											</a>
											<ul class="sub-menu">
												<?php
												sort($_SESSION['BBB']);
			...
			<script src="<?php echo base_url(); ?>assets/plugins/font-awesome/js/fontawesome.min.js"></script>
			...
			<script src="<?php echo base_url(); ?>assets/js/metrotheme.min.js"></script>
			<script src="<?php echo base_url(); ?>assets/js/lirs/js/lirs.js"></script>
