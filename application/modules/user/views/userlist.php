      ...
      <div class="panel panel-white">
        ...
        <div class="panel-heading hbuilt">
          ...
          <div class="panel-body" style="padding-bottom:0px;">
            <div class="col-md-12">
              <?php
              if(isset($user_list) and sizeof($user_list)>0) {
                ?>
                  ...
                  <tbody>
                    ...
                    foreach ($user_list as $list) {
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="btn-group">
                            <a href="<?php echo base_url(); ?>user/set_up/<?php echo $list['id']; ?>" class="btn btn-default btn-xs" title="Edit details">
                              <i class="fa fa-pencil"></i> Edit
                            </a>
                            <a href="<?php echo base_url(); ?>user/delete/<?php echo $list['id']; ?>" class="btn btn-danger btn-xs" title="Delete details" onclick="return confirm('Are you sure want to delete this role?')">
